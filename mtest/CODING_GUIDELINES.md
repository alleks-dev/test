...
### 15.5. Follow canonical namespace strategy
- topic naming, ACL scope, export/import rules і route scoping повинні відповідати canonical namespace strategy, зафіксованій в `ARCHITECTURE.md`
- не вводити альтернативні local-only namespace conventions у коді або tests без явного оновлення архітектурного контракту
